            ...
            <div className="latest-posts">
                <a href="#">
                  <div className="post d-flex align-items-center">
                    ...
                    <div className="title"><strong>Hotels for all budgets</strong>
                    <span className="date last-meta">October 26, 2016</span></div>
                  </div>
                  </a>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 text-right">
              <p>Template By <a href="#" className="text-white">Bootstrapious</a>
